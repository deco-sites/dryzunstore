...
function ProductMainRolex({ page }: Props) {
  ...
  const getAlternateName = (alternateName: string | undefined) => {
    return alternateName || `rolex ${name} em ${materia}, ${mer}* - Dryzun`;
  };
  ...
  return (
    <section id={id} class="bg-[#F9F7F4] relative rolex-container">
      <Head>
        <meta
          name="keywords"
            ...
            >
              ...
              >
                <g
                  ...
                  fill-rule="evenodd"
                >
                  <circle id="Oval" fill="#fff" cx="18" cy="18" r="18">
                  </circle>
                  <path
      ...
      <div class="flex flex-col gap-4 max-md:hidden">
        <div class="flex max-md:flex-col-reverse justify-between items-center">
