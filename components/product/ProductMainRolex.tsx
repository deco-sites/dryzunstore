  ...
  return (
    ...
    >
      ...
      <div class="max-md:w-full md:absolute left-[7%] md:left-[8%] grid gap-3 max-md:mt-5">
        ...
        <h1 class="headline50 text-[#452C1E] md:ml-[-1px] max-w-full">{name}</h1>
        ...
        <div className="justify-center md:justify-start gap-[30px] md:max-w-[380px] flex flex-wrap calls my-6">
          ...
          <a target="_blank" href={textWhats} class="md:min-w-[170px] max-md:text-[0] flex items-center text-xs font-bold text-[#452C1E] hover:text-[#127749]">
            <svg
              width="40px"
              height="40px" 
              class="md:mr-3" 
