...
function BreadCrumbRolex({ page }: Props) {
  ...
  const collectionLink = product.isVariantOf?.additionalProperty?.find((
    item: any,
  ...
  return (
    <div class="w-full py-4 bg-gradiente">
      <div class="rolex-container flex items-center">
        <a
          class="hidden md:flex items-center fixed14-ligth text-white mr-1"
          href="/rolex/descubra"
        >
          Rolex
        </a>
        ...
        <a
          class="flex items-center fixed14-ligth text-white mr-1"
          href={`${collectionLink}`}
        >
          <Icon
