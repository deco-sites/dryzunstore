...
function ProductCard({
  ...
  return (
    <div
      ...
      class="tagheuer-2b rounded-none bg-white card card-compact group w-full lg:p-4"
    >
      ...
      <div class="flex bg-white pb-4 flex-col gap-2">
        ...
        <div class="flex flex-col">
          <h2
            class="mt-5 text-center ellipsis h-[40px] text-ellipsis text-black max-w-[200px] mx-auto leading-5 text-sm font-semibold w-full flex"
            dangerouslySetInnerHTML={{ __html: name ?? "" }}
          />
        </div>

        {/* Price from/to */}
        <div class="hidden flex flex-col items-center justify-center text-sm not-italic font-normal leading-[normal] tracking-[0.42px] text-[#666461]">
