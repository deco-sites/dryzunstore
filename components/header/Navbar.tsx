        ...
        <div class="md:min-w-[355px] flex-none w-max flex items-center justify-end gap-2 col-span-1">
          ...
          <div class="relative group">
            {user.value?.email
              ? (
                <>
                  <a href="/_secure/account" class="items_menu flex items-center text-xs font-thin text-[#1A1A1A]" aria-label="Account">
              ...
              : 
              (
                <a href="/login" class="items_menu flex items-center text-xs font-thin text-[#1A1A1A]" aria-label="Account">
                  <div class="flex btn border-0 shadow-none btn-sm bg-transparent hover:bg-transparent px-0 gap-1">
                    <Icon id="Profile" size={20} strokeWidth={0.4} />
                  </div>
                </a>
