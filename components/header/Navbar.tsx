...
function Navbar(
  ...
  // Desktop header
  return (
    <div class="hidden md:flex flex-col justify-center items-center shadow-[0px_2px_7px_0px_rgba(0,0,0,0.08)] w-full container-2">
