...
export default function Form() {
  ...
  const handleSubmit: JSX.GenericEventHandler<HTMLFormElement> = async (e) => {
    ...
    try {
      ...
      const name = (e.currentTarget.elements.namedItem("name") as RadioNodeList)
        ?.value;
      const lastname = (e.currentTarget.elements.namedItem("lastname") as RadioNodeList)
        ?.value;
      const email =
        (e.currentTarget.elements.namedItem("email") as RadioNodeList)?.value;
      const phonecode =
        (e.currentTarget.elements.namedItem("phonecode") as RadioNodeList)?.value;
      const phone =
        (e.currentTarget.elements.namedItem("phone") as RadioNodeList)?.value;
      const city =
        (e.currentTarget.elements.namedItem("city") as RadioNodeList)?.value;
      const address =
  ...
  return (
    <div class="bg-[#F5F3F0] w-full my-0 pt-[60px] md:pt-[90px] max-md:px-[7%]">
      <h1 class="text-center text-[24px] text-[#452c1e] font-bold">Enviar uma mensagem</h1>
      <p class="text-center mb-5 text-[50px] text-[#452c1e] font-bold leading-[1.1]">
        {step.value ? 'Insira suas informações de contato' : 'Insira sua mensagem'}
      </p>
      <p class="text-center mb-10 text-[20px] md:max-w-[1000px] mx-auto">
        {step.value ? 'Usaremos essas informações para enviar uma resposta' : 'Agradecemos o seu interesse nos relógios Rolex. Insira sua mensagem abaixo e responderemos o mais brevemente possível.'}
      </p>
      <form
        class="w-full max-w-[1200px] mx-auto flex flex-wrap justify-between mt-10"
      ...
      >
          ...
          <>
            <div class="w-full mb-8 flex justify-between flex-wrap">
              <div class="w-full md:w-[14%] max-md:mb-8">
                ...
                <select class="w-full h-10 body20-ligth bg-transparent outline-none border-b transition-[0.3s]  rounded-sm border-solid border-b-[#6e5e567d] hover:border-[#212121]" name="title" id="title">
            ...
            <div class="w-full mb-8 flex justify-between flex-wrap">
              <div class="w-full md:w-[22%] max-md:mb-8">
                ...
                <select class="w-full h-10 body20-ligth bg-transparent outline-none border-b transition-[0.3s]  rounded-sm border-solid border-b-[#6e5e567d] hover:border-[#212121]" name="phonecode" id="phonecode">
                  ...
                  <option value="1684" data-name="American Samoa">American Samoa 1684</option>
                  ...
                  <option value="32" data-name="Belgium (België)">Belgium (België) 32</option>
                  <option value="501" data-name="Belize">Belize 501</option>
                  <option value="229" data-name="Benin (Bénin)">Benin (Bénin) 229</option>
                  <option value="1441" data-name="Bermuda">Bermuda 1441</option>
                  <option value="975" data-name="Bhutan (འབྲུག)">Bhutan (འབྲུག) 975</option>
                  <option value="591" data-name="Bolivia">Bolivia 591</option>
                  <option value="387" data-name="Bosnia and Herzegovina (Босна и Херцеговина)">
                    Bosnia and Herzegovina (Босна и Херцеговина) 387
                  </option>
                  <option value="267" data-name="Botswana">Botswana 267</option>
                  <option value="55" data-name="Brazil (Brasil)" selected> 55 Brasil</option>
                  ...
                  <option value="226" data-name="Burkina Faso">Burkina Faso 226</option>
                  ...
                  <option value="1345" data-name="Cayman Islands">Cayman Islands 1345</option>
                  <option value="236" data-name="Central African Republic (République centrafricaine)">
                    Central African Republic (République centrafricaine) 236
                  </option>
                  <option value="235" data-name="Chad (Tchad)">Chad (Tchad) 235</option>
                  <option value="56" data-name="Chile">Chile 56</option>
                  <option value="86" data-name="China (中国)">China (中国) 86</option>
                  <option value="61" data-name="Christmas Island">Christmas Island 61</option>
                  ...
                  <option value="243" data-name="Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo)">
                    Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo) 243
                  </option>
                  <option value="242" data-name="Congo (Republic) (Congo-Brazzaville)">
                    Congo (Republic) (Congo-Brazzaville) 242
                  </option>
                  <option value="682" data-name="Cook Islands">Cook Islands 682</option>
                  <option value="506" data-name="Costa Rica">Costa Rica 506</option>
                  <option value="225" data-name="Côte d’Ivoire">Côte d’Ivoire 225</option>
                  ...
                  <option value="357" data-name="Cyprus (Κύπρος)">Cyprus (Κύπρος) 357</option>
                  <option value="420" data-name="Czech Republic (Česká republika)">
                    Czech Republic (Česká republika) 420
                  </option>
                  <option value="45" data-name="Denmark (Danmark)">Denmark (Danmark) 45</option>
                  <option value="253" data-name="Djibouti">Djibouti 253</option>
                  <option value="1767" data-name="Dominica">Dominica 1767</option>
                  <option value="1" data-name="Dominican Republic (República Dominicana)">
                    Dominican Republic (República Dominicana) 1
                  </option>
                  <option value="593" data-name="Ecuador">Ecuador 593</option>
                  <option value="20" data-name="Egypt (‫مصر‬‎)">Egypt (‫مصر‬‎) 20</option>
                  <option value="503" data-name="El Salvador">El Salvador 503</option>
                  <option value="240" data-name="Equatorial Guinea (Guinea Ecuatorial)">
                    Equatorial Guinea (Guinea Ecuatorial) 240
                  </option>
                  <option value="291" data-name="Eritrea">Eritrea 291</option>
                  <option value="372" data-name="Estonia (Eesti)">Estonia (Eesti) 372</option>
                  ...
                  <option value="358" data-name="Finland (Suomi)">Finland (Suomi) 358</option>
                  <option value="33" data-name="France">France 33</option>
                  <option value="594" data-name="French Guiana (Guyane française)">
                    French Guiana (Guyane française) 594
                  </option>
                  <option value="689" data-name="French Polynesia (Polynésie française)">
                  ...
                  <option value="233" data-name="Ghana (Gaana)">Ghana (Gaana) 233</option>
                  <option value="350" data-name="Gibraltar">Gibraltar 350</option>
                  <option value="30" data-name="Greece (Ελλάδα)">Greece (Ελλάδα) 30</option>
                  ...
                  <option value="224" data-name="Guinea (Guinée)">Guinea (Guinée) 224</option>
                  ...
                  <option value="852" data-name="Hong Kong (香港)">Hong Kong (香港) 852</option>
                  <option value="36" data-name="Hungary (Magyarország)">
                    Hungary (Magyarország) 36
                  </option>
                  <option value="354" data-name="Iceland (Ísland)">Iceland (Ísland) 354</option>
                  <option value="91" data-name="India (भारत)">India (भारत) 91</option>
                  <option value="62" data-name="Indonesia">Indonesia 62</option>
                  <option value="98" data-name="Iran (‫ایران‬‎)">Iran (‫ایران‬‎) 98</option>
                  <option value="964" data-name="Iraq (‫العراق‬‎)">Iraq (‫العراق‬‎) 964</option>
                  <option value="353" data-name="Ireland">Ireland 353</option>
                  <option value="44" data-name="Isle of Man">Isle of Man 44</option>
                  <option value="972" data-name="Israel (‫ישראל‬‎)">Israel (‫ישראל‬‎) 972</option>
                  <option value="39" data-name="Italy (Italia)">Italy (Italia) 39</option>
                  <option value="1876" data-name="Jamaica">Jamaica 1876</option>
                  <option value="81" data-name="Japan (日本)">Japan (日本) 81</option>
                  ...
                  <option value="371" data-name="Latvia (Latvija)">Latvia (Latvija) 371</option>
                  ...
                  <option value="218" data-name="Libya (‫ليبيا‬‎)">Libya (‫ليبيا‬‎) 218</option>
                  <option value="423" data-name="Liechtenstein">Liechtenstein 423</option>
                  <option value="370" data-name="Lithuania (Lietuva)">
                    Lithuania (Lietuva) 370
                  </option>
                  <option value="352" data-name="Luxembourg">Luxembourg 352</option>
                  <option value="853" data-name="Macau (澳門)">Macau (澳門) 853</option>
                  ...
                  <option value="692" data-name="Marshall Islands">Marshall Islands 692</option>
                  <option value="596" data-name="Martinique">Martinique 596</option>
                  <option value="222" data-name="Mauritania (‫موريتانيا‬‎)">
                    Mauritania (‫موريتانيا‬‎) 222
                  </option>
                  <option value="230" data-name="Mauritius (Moris)">Mauritius (Moris) 230</option>
                  <option value="262" data-name="Mayotte">Mayotte 262</option>
                  <option value="52" data-name="Mexico (México)">Mexico (México) 52</option>
                  ...
                  <option value="976" data-name="Mongolia (Монгол)">Mongolia (Монгол) 976</option>
                  <option value="382" data-name="Montenegro (Crna Gora)">
                    Montenegro (Crna Gora) 382
                  </option>
                  <option value="1664" data-name="Montserrat">Montserrat 1664</option>
                  ...
                  <option value="264" data-name="Namibia (Namibië)">Namibia (Namibië) 264</option>
                  <option value="674" data-name="Nauru">Nauru 674</option>
                  <option value="977" data-name="Nepal (नेपाल)">Nepal (नेपाल) 977</option>
                  <option value="31" data-name="Netherlands (Nederland)">
                    Netherlands (Nederland) 31
                  </option>
                  <option value="687" data-name="New Caledonia (Nouvelle-Calédonie)">
                  ...
                  <option value="227" data-name="Niger (Nijar)">Niger (Nijar) 227</option>
                  <option value="234" data-name="Nigeria">Nigeria 234</option>
                  <option value="683" data-name="Niue">Niue 683</option>
                  <option value="672" data-name="Norfolk Island">Norfolk Island 672</option>
                  <option value="850" data-name="North Korea (조선 민주주의 인민 공화국)">
                    North Korea (조선 민주주의 인민 공화국) 850
                  </option>
                  <option value="1670" data-name="Northern Mariana Islands">
                    Northern Mariana Islands 1670
                  </option>
                  <option value="47" data-name="Norway (Norge)">Norway (Norge) 47</option>
                  <option value="968" data-name="Oman (‫عُمان‬‎)">Oman (‫عُمان‬‎) 968</option>
                  ...
                  <option value="507" data-name="Panama (Panamá)">Panama (Panamá) 507</option>
                  <option value="675" data-name="Papua New Guinea">Papua New Guinea 675</option>
                  ...
                  <option value="48" data-name="Poland (Polska)">Poland (Polska) 48</option>
                  <option value="351" data-name="Portugal">Portugal 351</option>
                  <option value="1" data-name="Puerto Rico">Puerto Rico 1</option>
                  <option value="974" data-name="Qatar (‫قطر‬‎)">Qatar (‫قطر‬‎) 974</option>
                  <option value="262" data-name="Réunion (La Réunion)">
                    Réunion (La Réunion) 262
                  </option>
                  <option value="40" data-name="Romania (România)">Romania (România) 40</option>
                  <option value="7" data-name="Russia (Россия)">Russia (Россия) 7</option>
                  <option value="250" data-name="Rwanda">Rwanda 250</option>
                  <option value="590" data-name="Saint Barthélemy">Saint Barthélemy 590</option>
                  <option value="290" data-name="Saint Helena">Saint Helena 290</option>
                  <option value="1869" data-name="Saint Kitts and Nevis">
                    Saint Kitts and Nevis 1869
                  </option>
                  <option value="1758" data-name="Saint Lucia">Saint Lucia 1758</option>
                  <option value="590" data-name="Saint Martin (Saint-Martin (partie française))">
                    Saint Martin (Saint-Martin (partie française)) 590
                  </option>
                  <option value="508" data-name="Saint Pierre and Miquelon (Saint-Pierre-et-Miquelon)">
                  ...
                  <option value="239" data-name="São Tomé and Príncipe (São Tomé e Príncipe)">
                    São Tomé and Príncipe (São Tomé e Príncipe) 239
                  </option>
                  <option value="966" data-name="Saudi Arabia (‫المملكة العربية السعودية‬‎)">
                    Saudi Arabia (‫المملكة العربية السعودية‬‎) 966
                  </option>
                  <option value="221" data-name="Senegal (Sénégal)">Senegal (Sénégal) 221</option>
                  <option value="381" data-name="Serbia (Србија)">Serbia (Србија) 381</option>
                  <option value="248" data-name="Seychelles">Seychelles 248</option>
                  <option value="232" data-name="Sierra Leone">Sierra Leone 232</option>
                  <option value="65" data-name="Singapore">Singapore 65</option>
                  <option value="1721" data-name="Sint Maarten">Sint Maarten 1721</option>
                  ...
                  <option value="677" data-name="Solomon Islands">Solomon Islands 677</option>
                  <option value="252" data-name="Somalia (Soomaaliya)">
                    Somalia (Soomaaliya) 252
                  </option>
                  <option value="27" data-name="South Africa">South Africa 27</option>
                  ...
                  <option value="34" data-name="Spain (España)">Spain (España) 34</option>
                  ...
                  <option value="46" data-name="Sweden (Sverige)">Sweden (Sverige) 46</option>
                  <option value="41" data-name="Switzerland (Schweiz)">
                    Switzerland (Schweiz) 41
                  </option>
                  <option value="963" data-name="Syria (‫سوريا‬‎)">Syria (‫سوريا‬‎) 963</option>
                  <option value="886" data-name="Taiwan (台灣)">Taiwan (台灣) 886</option>
                  <option value="992" data-name="Tajikistan">Tajikistan 992</option>
                  <option value="255" data-name="Tanzania">Tanzania 255</option>
                  <option value="66" data-name="Thailand (ไทย)">Thailand (ไทย) 66</option>
                  <option value="670" data-name="Timor-Leste">Timor-Leste 670</option>
                  ...
                  <option value="216" data-name="Tunisia (‫تونس‬‎)">Tunisia (‫تونس‬‎) 216</option>
                  <option value="90" data-name="Turkey (Türkiye)">Turkey (Türkiye) 90</option>
                  <option value="993" data-name="Turkmenistan">Turkmenistan 993</option>
                  ...
                  <option value="380" data-name="Ukraine (Україна)">Ukraine (Україна) 380</option>
                  <option value="971" data-name="United Arab Emirates (‫الإمارات العربية المتحدة‬‎)">
                  ...
                  <option value="84" data-name="Vietnam (Việt Nam)">Vietnam (Việt Nam) 84</option>
                  <option value="681" data-name="Wallis and Futuna (Wallis-et-Futuna)">
                    Wallis and Futuna (Wallis-et-Futuna) 681
                  </option>
                  <option value="212" data-name="Western Sahara (‫الصحراء الغربية‬‎)">
                    Western Sahara (‫الصحراء الغربية‬‎) 212
                  </option>
                  <option value="967" data-name="Yemen (‫اليمن‬‎)">Yemen (‫اليمن‬‎) 967</option>
                  <option value="260" data-name="Zambia">Zambia 260</option>
                  <option value="263" data-name="Zimbabwe">Zimbabwe 263</option>
                  <option value="358" data-name="Åland Islands">Åland Islands 358</option>
                </select>
              </div>
        ...
        {!step.value && (
          <div class="w-full mb-8 flex flex-col">
            ...
            <button class="my-4 mx-auto w-[150px] h-12 float-right flex items-center justify-center bg-[#127749] hover:bg-[#0b4c2f] fixed14 text-white transition-[0.3s] rounded-[50px] border-0" onClick={() => step.value = true} >Próximo</button>
          </div>
        )}
          ...
          step.value && (
            <>
              <div class="w-full flex items-center mb-8 relative">
                <input required checked={accept.value} type="checkbox" name="accept" class="opacity-0 absolute left-0" />
                <div onClick={() => accept.value = !accept.value} class={`min-w-5 max-w-5 min-h-5 max-h-5 border cursor-pointer flex items-center justify-center before:text-white mr-2 relative before:content-['✓'] before:aboslute rounded-[50%] border-solid ${accept.value ? 'border-[#127749] bg-[#127749]' : 'border-[#6e5e567d]'}`}></div>
                <p class="legend16 text-[#212121]">*Eu li e aceito os <a class="hover:underline text-[#127749] text-[bold]" href="/institucional/privacidade" target="_blank" rel="noopener noreferrer">Termos e Condições e a Política de Privacidade.</a></p>
              </div>
              ...
              {success.value
                ? <p class="w-full mt-7 text-center">Agradecemos o seu interesse nos relógios Rolex. Sua mensagem foi
                  enviada com sucesso. Após análise de sua solicitação, um dos nossos representantes a
                  responderá o mais rapidamente possível.</p>
                : <></>}
            </>
          )
        }
