...
export default function Form() {
  ...
  return (
    <div class="max-w-[700px] w-full mx-auto my-0 pt-[60px] md:pt-[90px] max-md:px-[7%]">
      ...
      <p class="body20-ligth text-[#212121]">Por favor, indique o meio de contato de sua preferência. Nós o responderemos o mais rápido possível.</p>
      <form
      ...
      >
        <div class="w-full mb-8 flex justify-between flex-wrap">
          <div class="w-full md:w-[14%] max-md:mb-8">
            ...
            <select class="w-full h-10 body20-ligth outline-none border-b transition-[0.3s]  rounded-sm border-solid border-b-[#6e5e567d] hover:border-[#212121]" name="title" id="title">
        ...
        <div class="w-full mb-8 flex justify-between flex-wrap">
          ...
          <div class="w-[20%] md:w-[14%] max-md:mb-8">
            ...
            <select class="w-full h-10 body20-ligth outline-none border-b transition-[0.3s]  rounded-sm border-solid border-b-[#6e5e567d] hover:border-[#212121]" name="phonecode" id="phonecode">
        ...
        <div class="w-full flex items-center mb-8 relative">
          ...
          <p class="legend16-ligth text-[#212121]">*Eu li e aceito os <a class="hover:underline text-[#127749] text-[bold]" href="/institucional/privacidade" target="_blank" rel="noopener noreferrer">Termos e Condições e a Política de Privacidade.</a></p>
        </div>
