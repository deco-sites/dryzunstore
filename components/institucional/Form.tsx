  ...
  return (
    <div class="bg-[#F5F3F0] w-full my-0 pt-[60px] md:pt-[90px] max-md:px-[7%]">
      ...
      <p class="text-center mb-10 text-[20px] md:max-w-[1000px] mx-auto">
        {step.value
          ? "Usaremos essas informações para enviar uma resposta"
            ...
            {success.value
              ? (
                <p class="w-full mt-7 text-center">
                  Agradecemos o seu interesse nos relógios Rolex. Sua mensagem
                  foi enviada com sucesso. Após análise de sua solicitação, um
                  dos nossos representantes a responderá o mais rapidamente
                  possível.
                </p>
              )
              : <></>}
