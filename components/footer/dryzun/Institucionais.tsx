    ...
    <>
      <div class="py-12 hidden md:flex flex-row gap-6 items-start justify-between">
        <div class="w-auto md:flex flex-col">
          <h4 class="text-[13px] not-italic font-medium leading-[normal] tracking-[1.3px] uppercase text-[#333] mb-4">
            Contato
          </h4>
        ...
        <div>
          ...
          <ul class="flex items-center gap-4">
            {sociais && sociais?.map((social: SocialI) => (
              <li>
                <a
                  class="flex w-10 h-10 flex-col justify-center items-center gap-2.5 border rounded-[50%] border-solid border-[#E8EDF5]"
                  href={social?.link}
                  target="_blank"
                >
      ...
      <div class="flex md:hidden flex-col md:hidden items-start justify-between">
        <div class="w-full order-1 collapse collapse-arrow flex-col border-[#E0DEDA] rounded-none border-t border-b border-solid">
          ...
          <h4 class="flex items-center text-[13px] collapse-title after:text-[#666461] not-italic font-medium leading-[normal] tracking-[1.3px] uppercase text-[#333]">
            Contato
          </h4>
        ...
        <div class="w-full order-0 py-10">
          <h4 class="text-[13px] text-center not-italic font-medium leading-[normal] tracking-[1.3px] uppercase text-[#333] mb-4">
            Junte-se à nós
          </h4>
