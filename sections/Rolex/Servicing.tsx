      ...
      <div class="w-full">
        <Picture preload={true}>
          <Source
            ...
            fetchPriority="auto"
            src="https://dryzun.vteximg.com.br/arquivos/"
            width={780}
            height={520}
          />
          <Source
      ...
      <section class="bg-rolex-3 py-[60px] md:py-[90px]">
        <div class="w-full md:w-[600px] mx-auto max-md:px-[7%]">
          ...
          <p class="mt-6 body20-ligth text-[#212121]">
            ...
            questão de dar atenção redobrada ao seu relógio. A [Nome do
            distribuidor] é um centro de serviço autorizado Rolex e
            compromete-se a oferecer-lhe um serviço pós-venda de excelência.
            Graças à exigência e ao know-how de nossos relojoeiros, o seu
            relógio Rolex pode conservar, ao longo do tempo, tanto a sua
            excelente confiabilidade quanto seu brilho impecável.
          </p>
        </div>
      </section>
