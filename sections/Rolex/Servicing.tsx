    ...
    return (
        <>
            ...
            <section class="pt-[60px] md:pt-[90px] rolex-container gap-8 flex max-md:flex-col justify-between items-center bg-rolex-3">
                <h1 class="w-full md:w-[44%] headline50 text-[#452c1e]">SERVIÇO DE MANUTENÇÃO E REPARAÇÃO DE RELÓGIOS ROLEX NA DRYZUN</h1>
            ...
            <section class="bg-rolex-2 py-[60px] md:py-[90px]">
                <div class="w-full md:w-[600px] mx-auto pb-[60px] md:pb-[90px] max-md:px-[7%]">
                    <h2 class="headline50 text-[#452c1e]">A MANUTENÇÃO ROLEX NA DRYZUN</h2>
