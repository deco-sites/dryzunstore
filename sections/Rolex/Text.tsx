  ...
  return (
    ...
    >
      <div class={`${isColumns && "w-full md:w-[40%]"}`}>
        {subtitle && (
          <p class="f-rolex text-xl leading-[1.2] font-light text-[#452c1e]">
            {subtitle}
          </p>
        )}
        {NotisH1
          ? (
            <h2
              class={`${
                screen == "S" && "md:w-[600px] mx-auto"
              } f-rolex text-[30px] md:text-[50px] leading-[1.1] font-boldd text-[#452c1e] mb-2`}
            >
              {title}
            </h2>
          )
      ...
      >
        <p
          ...
          class={`${screen == "S" && "md:w-[600px] mx-auto"} f-rolex font-p`}
        >
        </p>
      </div>
    </div>
