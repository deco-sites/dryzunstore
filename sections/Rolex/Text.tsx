  ...
  return (
    ...
    >
      <div class={`${isColumns && "w-full md:w-[45%]"}`}>
        {subtitle && (
          <div class="f-rolex text-xl leading-[1.2] font-light text-[#452c1e]">
            <p
              dangerouslySetInnerHTML={{ __html: subtitle }}
              class="f-rolex text-xl leading-[1.2] font-light text-[#452c1e]"
            >
              {subtitle}
            </p>
          </div>
        ...
        {NotisH1
          ? (
            <h2
              ...
              class={`${
                screen == "S" && "md:w-[570px] xxl:w-[800px] mx-auto"
              } f-rolex text-[30px] md:text-[36px] leading-[1.1] font-boldd text-[#452c1e] mb-2`}
            >
              {title}
            </h2>
          )
      ...
      <div
        class={`newfont ${isColumns && "w-full md:w-[50%] md:pr-[8%]"} ${
          screen == "S" && "md:w-[570px] xxl:w-[800px] mx-auto"
        } f-rolex font-p`}
      >
        <p
