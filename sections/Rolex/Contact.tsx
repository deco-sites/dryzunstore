    ...
    <>
      ...
      <section class="rolex-container-2 max-md:flex-col-reverse flex items-center bg-rolex-3 py-[60px] md:py-[90px]">
        <div class="w-full md:w-[50%]">
          <iframe
            class="w-full"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1828.8645606174746!2d-46.65918762749966!3d-23.542243194350554!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce583bbe6ec0d3%3A0x4ff825db7c6e673a!2sDryzun%20%E2%80%93%20Distribuidor%20Oficial%20Rolex%C2%AE!5e0!3m2!1spt-BR!2sbr!4v1717616487593!5m2!1spt-BR!2sbr"
            width="800"
            height="688"
            style="border:0;"
            allowFullScreen
        ...
        <div class="w-full h-auto max-md:mb-5 md:h-[688px] bg-white flex flex-col justify-center md:w-[50%] p-6 md:pl-[80px] gap-4">
          ...
          <a
            target="_blank"
            class="flex items-center py-1 fixed14 text-[12px] font-[bold] text-[#452c1e]"
            href="tel:1138234100"
          >
            <img
              class="mr-2"
              width={20}
              src="https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9049/b918e292-1021-40f2-ab46-b688342d0508"
              alt="icon"
            />
            (11) 3823 4100
          </a>
          ...
          >
            <img
              class="mr-2"
              width={20}
              src="https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9049/b686900c-f905-49dc-beb5-07641f6b57b6"
              alt="icon"
            />
            WhatsApp
          </a>
          ...
          >
            <img
              class="mr-2"
              width={20}
              src="https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9049/cb03b802-89d9-4714-a60c-7b902ab46e61"
              alt="icon"
            />
            Itinerário
          </a>
          ...
          >
            <img
              class="mr-2"
              width={20}
              src="https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9049/378afd24-2500-4452-a0de-e9de4e7ede9c"
              alt="icon"
            />
      ...
      <section class="w-full">
        <Picture preload={true}>
          <Source
            media="(max-width: 767px)"
            fetchPriority="auto"
            src="https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9049/7296866d-e236-4ed1-b809-d3314e31db12"
            width={740}
            height={840}
          />
          <Source
            media="(min-width: 768px)"
            fetchPriority="auto"
            src="https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9049/e8169a58-9e3b-48c2-a1c3-29d4740b1b1a"
            width={2880}
            height={1700}
          />
          <img
