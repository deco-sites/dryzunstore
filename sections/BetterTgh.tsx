        ...
        <div class="py-8">
                    ...
                    <a href={linkCollectionPage ? linkCollectionPage : ""}>
                        <img
                            src={bannerPrincipalMobile
                                ? bannerPrincipalMobile
                                : "https://dryzun.vteximg.com.br/arquivos/bannerprinc-mob_better_tgh.png"}
            ...
            {bannerBetterDesk && (
                <div class="justify-center mx-auto hidden md:block">
                    <img
                        src={bannerBetterDesk
                            ? bannerBetterDesk
                            : "https://dryzun.vteximg.com.br/arquivos/Selo_better_tgh.png"}
            ...
            <div class="flex justify-center items-center gap-10 md:gap-[100px] flex-col md:flex-row">
                ...
                >
                    {textoEsquerda
                        ? textoEsquerda
                        : "Quando dois caminhos se cruzam e tudo faz sentido. Better Together celebra a harmonia dos encontros, das presenças que preenchem e do amor que se revela nos detalhes. Joias que traduzem a beleza de viver ao lado de quem torna cada momento mais especial."}
                </p>
            ...
            >
                {textoMeio
                    ? textoMeio
                    : "Better Together — porque algumas conexões fazem tudo brilhar mais."}
            </p>
