...
export default function ToqueDeAmor(
    ...
    return (
        <div class="container-2 py-8">
            ...
            {textoMontserrat && (
                <p class="text-center my-16 text-[#aa8a47] text-3xl md-text-5xl font-bold tracking-widest max-sm:text-[32px]" style={{ fontFamily: "Montserrat, sans-serif" }}>{textoMontserrat}</p>
            )}

            {textoDigital && (
                <p style={{ fontFamily: "Montserrat, sans-serif" }} class="text-sm w-fit leading-[140%] md:leading-normal max-sm:py-4 md:text-2xl text-center text-[#545454] mb-16 mx-auto mt-0 md:w-[564px] h-[500px] bg-no-repeat bg-contain bg-center flex items-center bg-[url(https://dryzun.vtexassets.com/assets/vtex.file-manager-graphql/images/c3f1f913-a335-4fa5-b2b1-b5552edb0615___0914a307bb87b8e13f0c8efba8ee703e.svg)]">
                    {textoDigital}
                </p>
            )}
            ...
            {textoMeio && (
                <div class="bg-[#f4f3f0] my-0 md:w-[1320px] mt-16 mx-auto w-full">
                    <p style={{ fontFamily: "Montserrat, sans-serif" }} class="text-center text-[#545454] md:text-lg py-8 w-[320px] text-xs leading-[150%] md:leading-normal md:w-[640px] mx-auto my-16 font-light">{textoMeio}</p>
                </div>
            )}
            ...
            <p style={{ fontFamily: "Montserrat, sans-serif" }} class="text-[#39293d] my-0 mx-auto text-center text-sm md:text-lg font-extralight">
                Pingente  em ouro amarelo  Personalizado com a digital do seu filho
            </p>

            <p style={{ fontFamily: "Montserrat, sans-serif" }} class="text-[#39293d] my-3 md:my-6 mx-auto text-center text-sm md:text-lg font-extralight">
